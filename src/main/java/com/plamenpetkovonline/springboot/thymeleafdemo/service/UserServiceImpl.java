...
import com.plamenpetkovonline.springboot.thymeleafdemo.dao.RoleDao;
import com.plamenpetkovonline.springboot.thymeleafdemo.dao.UserDao;
...
//        user.setRoles(Arrays.asList(roleDao.findRoleByName("ROLE_EMPLOYEE")));
        // for testing purposes will give user all roles by default
        user.setRoles((roleDao.findRoles()));
